...
-- 
--
-- custid and contactname columns from the Sales.Customers table and the
...
-- Task 3a
-- 
-- Copy the existing T-SQL statement from task 2 and modify it so that
-- the result will return all employees and be ordered by the manager’s first name. 
