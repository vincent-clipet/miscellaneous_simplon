...
-- Task 1
-- 
-- Write a SELECT statement that will return the
-- custid, companyname, contactname, address, city, country, and phone columns
...
-- Task 5
-- 
-- retrieve customers from the Sales.Customers table that do not have matching orders in the Sales.Orders table. 

-- Matching customers with orders is based on a comparison between the customer’s custid value
